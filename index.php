	...
	<body>
		<main role="main" class="container">
	    		<div class="starter-template"> <br>
	        		<h1>Image Analyzer by NgetestWeb</h1>
					<p class="lead">Select photos from the computer that you want to analyze. Then click <b>Upload</b> <br>To start the photo analysis process, select <b>Analyze!</b> in the selection of images in each list.</p>
							...
							<tr>
								...
								<td>
									<form action="testVision.php" method="post">
										...
										<input type="submit" name="submit" value="Analyze It!" class="btn btn-primary">
									</form>
								</td>
							</tr>
							<?php
